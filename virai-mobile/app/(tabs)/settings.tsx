...
export default function SettingsScreen() {
  ...
  const handleSaveName = () => {
    if(nameInput.trim()) {
      ...
      Alert.alert("Success", `Hello ${nameInput}, settings updated.`);
    }
  };
        ...
        <View style={styles.section}>
          ...
          <TouchableOpacity style={styles.menuItem}>
            <View style={{flexDirection:'row', alignItems:'center'}}>
              ...
              <Text style={styles.menuText}>Rate ViraFlow</Text>
            </View>
            <Ionicons name="chevron-forward" size={20} color={COLORS.accent} />
          </TouchableOpacity>
           ...
           <View style={styles.menuItem}>
            ...
            <Text style={{color:COLORS.accent}}>v1.2.0</Text>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  sectionTitle: { color: COLORS.accent, fontSize: 12, fontWeight: 'bold', marginBottom: 10, letterSpacing: 1 },
  ...
  label: { color: COLORS.accent, fontSize: 12, marginBottom: 5 },
  input: { color: COLORS.text, fontSize: 18, fontWeight: '500', borderBottomWidth: 1, borderBottomColor: '#433D35', paddingBottom: 5 },
  menuItem: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: COLORS.card, padding: 15, borderRadius: 10, marginBottom: 10 },
